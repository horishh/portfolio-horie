...
const Home = () => {
  return (
    <section
      id="home"
      className="relative flex flex-col items-center justify-center min-h-[70dvh] sm:min-h-dvh px-6 sm:px-10 pb-30 sm:pb-0 transition-colors duration-500 mb-40"
      style={{
